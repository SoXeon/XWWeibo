...
- (void)viewDidLoad {
    ...
    _menuView.scrollView.scrollEnabled = NO;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (targetIndex >= 0 && targetIndex < self.childControllers.count) {
        ...
        if (isToNextItem) {
            ...
            offset.x = ((nextItemOffsetX - currentItemOffsetX) * ratio + currentItemOffsetX) * 0.001;
            ...
            CGPoint offset = _menuView.scrollView.contentOffset;
            offset.x = (currentItemOffsetX - (nextItemOffsetX - currentItemOffsetX) * ratio) * 0.001;
            [_menuView.scrollView setContentOffset:offset animated:NO];
